			...
			<div class="container">
		    	...
		    	<div class="navbar-header">
		    		<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
		      		...
		      		<a class="navbar-brand" href="<?php echo BASE_URL.'/admin'; ?>" data-toggle="tooltip" data-placement="right" title="MY_SHOP"><i class="fa fa-shopping-cart fa-lg"></i> Dashboard</a>
		    	</div>
