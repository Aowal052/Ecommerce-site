...
<?php
    ...
    if(isset($_POST["update_product"])) {
        ...
        $product_id_new         = mysql_real_escape_string($_POST['product_id']);
        $product_name_new       = mysql_real_escape_string($_POST['product_name']);
        $product_price_new      = mysql_real_escape_string($_POST['product_price']);
        $product_cat_id_new     = mysql_real_escape_string($_POST['product_cat_id']);
        $product_details_new    = mysql_real_escape_string($_POST['product_details']);
