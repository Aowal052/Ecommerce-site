					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<?php  
	                            ...
	                            $query = "SELECT * FROM tbl_products ORDER BY product_id DESC LIMIT 3";
							...
							<div class="item <?php echo $active ?>">
								...
								<div class="col-sm-6">
									...
									<span style="position: absolute;top: 78%; right:74%; background-color: #f0f0e9; color: #fe9808; padding: 7px;">TK <?php echo $product_price ?></span>
								</div>
							</div>
